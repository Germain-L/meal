...
export type LoginPost401ResponseErrorEnum =
	(typeof LoginPost401ResponseErrorEnum)[keyof typeof LoginPost401ResponseErrorEnum];
...
export function LoginPost401ResponseFromJSONTyped(
	json: any,
...
export function LoginPost401ResponseToJSONTyped(
	value?: LoginPost401Response | null,
