...
export type LoginPost500ResponseErrorEnum =
	(typeof LoginPost500ResponseErrorEnum)[keyof typeof LoginPost500ResponseErrorEnum];
...
export function LoginPost500ResponseFromJSONTyped(
	json: any,
...
export function LoginPost500ResponseToJSONTyped(
	value?: LoginPost500Response | null,
